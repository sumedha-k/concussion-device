...
import com.example.concussioncalendar.R
...
class Calindar : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        calendarView.dayBinder = object : DayBinder<DayViewContainer> {
            ...
            override fun bind(container: DayViewContainer, day: CalendarDay) {
                ...
                if (day.owner == DayOwner.THIS_MONTH) {
                    // Set days pertaining to this month a particular color
                    textView.setTextColor(Color.WHITE)
                    // Show the month dates. Remember that views are recycled!
                    // textView.visibility = View.VISIBLE
                    if (day.date == selectedDate) {
                        // If this is the selected date, show a round background and change the text color.
                        // textView.setTextColor(Color.rgb(0x65,0x68,0xb8)) // figure out how to do this by referencing the color variable i made in colors.xml
